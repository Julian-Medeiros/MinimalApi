...
public class Startup
{
    ...
    #region Métodos
        ErrosDeValidacao validaVeiculoDTO(VeiculoDTO veiculoDTO)
        {
            ...
            if (string.IsNullOrEmpty(veiculoDTO.Modelo))
                validacao.Mensagens.Add("O Modelo não pode ficar em branco");
        ...
        ErrosDeValidacao validaAdministradorDTO(AdministradorDTO administradorDTO)
        {
            ...
            if (administradorDTO.Perfil != Perfil.Adm && administradorDTO.Perfil != Perfil.Editor)
                validacao.Mensagens.Add("Pefil inválido.");
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseEndpoints(endpoints =>
        {
            ...
            {
                var administrador = administradorServico.GetById(id);
            ...
            endpoints.MapPut("/Administradores/{id}", ([FromRoute] int id,AdministradorDTO administradorDTO, IAdministradorServico administradorServico) =>
            {
                ...
                administradorServico.Update(administrador);
